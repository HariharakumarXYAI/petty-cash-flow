...
export const countries = [
  ...
  { code: "KH" as Country, name: "Cambodia", currency: "USD", flag: "🇰🇭" },
...
export const stores: StoreInfo[] = [
  ...
  { id: "s7", name: "Makro Phnom Penh 1", country: "KH", type: "Hypermarket", legalEntity: "Makro Cambodia Co Ltd", currency: "USD", floatLimit: 2000, minBalance: 500, maxFloat: 3500, replenishmentThreshold: 700, currentBalance: 1450 },
  { id: "s8", name: "Makro Siem Reap", country: "KH", type: "Supermarket", legalEntity: "Makro Cambodia Co Ltd", currency: "USD", floatLimit: 1200, minBalance: 300, maxFloat: 2000, replenishmentThreshold: 400, currentBalance: 320 },
...
export const claims: Claim[] = [
  ...
  { id: "c3", claimNumber: "PC-KH-2026-00038", storeId: "s7", store: "Makro Phnom Penh 1", country: "KH", storeType: "Hypermarket", submitter: "Sok Vannak", expenseType: "Maintenance", subcategory: "Minor Repairs", amount: 125, currency: "USD", status: "On Hold", submittedAt: "2026-03-06T07:30:00", receiptDate: "2026-03-04", vendor: "PP Fix It Services", notes: "Freezer door hinge replacement", ocrConfidence: 72, hasAlert: true, paymentMode: "Cash" },
...
export const alerts: AlertRecord[] = [
  ...
  { id: "al8", type: "limit_breach", severity: "high", title: "Store below minimum petty cash fund balance", description: "Makro Sathorn current balance ฿6,200 is approaching the minimum threshold of ฿5,000.", storeId: "s2", store: "Makro Sathorn", country: "TH", storeType: "Supermarket", expenseCategory: "N/A", amountDeviation: 0, peerBenchmark: 0, actualAmount: 6200, yoyChange: 0, assignedTo: "Thanyarat C.", status: "Open", createdAt: "2026-03-06T06:00:00", reasonCodes: ["LOW_BALANCE"], notes: ["Replenishment request pending"] },, description: "Makro Sathorn current balance ฿6,200 is approaching the minimum threshold of ฿5,000.", storeId: "s2", store: "Makro Sathorn", country: "TH", storeType: "Supermarket", expenseCategory: "N/A", amountDeviation: 0, peerBenchmark: 0, actualAmount: 6200, yoyChange: 0, assignedTo: "Thanyarat C.", status: "Open", createdAt: "2026-03-06T06:00:00", reasonCodes: ["LOW_BALANCE"], notes: ["Replenishment request pending"] },, type: "limit_breach", severity: "high", title: "Store below minimum petty cash fund balance", description: "Makro Sathorn current balance ฿6,200 is approaching the minimum threshold of ฿5,000.", storeId: "s2", store: "Makro Sathorn", country: "TH", storeType: "Supermarket", expenseCategory: "N/A", amountDeviation: 0, peerBenchmark: 0, actualAmount: 6200, yoyChange: 0, assignedTo: "Thanyarat C.", status: "Open", createdAt: "2026-03-06T06:00:00", reasonCodes: ["LOW_BALANCE"], notes: ["Replenishment request pending"] },, description: "Makro Sathorn current balance ฿6,200 is approaching the minimum threshold of ฿5,000.", storeId: "s2", store: "Makro Sathorn", country: "TH", storeType: "Supermarket", expenseCategory: "N/A", amountDeviation: 0, peerBenchmark: 0, actualAmount: 6200, yoyChange: 0, assignedTo: "Thanyarat C.", status: "Open", createdAt: "2026-03-06T06:00:00", reasonCodes: ["LOW_BALANCE"], notes: ["Replenishment request pending"] },
];
